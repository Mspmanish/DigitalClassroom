<%@ Page Title="" Language="C#" MasterPageFile="~/D-Classroom.Master" AutoEventWireup="true" CodeBehind="Faculty_signup.aspx.cs" Inherits="DigitalClassroom.Faculty_signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-5" style="box-shadow: 10px 10px 26px -10px rgba(0,0,0,0.7); -webkit-box-shadow: 10px 10px 26px -10px rgba(0,0,0,0.7); -moz-box-shadow: 10px 10px 26px -10px rgba(0,0,0,0.7);">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-12">
                <h1 class="jumbotron bg-secondary  text-white text-center">Faculty Sign</h1>
            </div>
        ...
        <div class=" row">
            ...
            <div class="col-md-4">
                ...
                <asp:TextBox ID="NameTextBox" runat="server" CssClass="form-control" placeholder="Enter FacultyName"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter FacultyName" ControlToValidate="NameTextBox" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                <br />
            ...
            <div class=" col-md-4">
                ...
                <br />
                <asp:TextBox ID="UserId" runat="server" CssClass="form-control" placeholder="Enter FacultyId"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ErrorMessage="Enter FacultyId" ControlToValidate="UserId" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                <br />
